...
int main()
{
    ...
    // -------------------------
    //Shader shader("res/Shader/depth_testing.shader");
    Shader shader("res/Shader/framebuffers.shader");
    Shader screenShader("res/Shader/framebuffers_screen.shader");
    //Shader shaderSingleColor("res/Shader/single_color.shader");
    //Shader shader("res/Shader/blending.shader");
    ...
    //unsigned int transparentTexture = loadTexture("res/image/grass.png");
    //unsigned int windowTexture = loadTexture("res/image/blending_transparent_window.png");
